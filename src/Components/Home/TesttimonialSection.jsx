...
export default function TestimonialSection() {
  ...
  return (
    <div className="w-full mt-20 h-[1200px]  md:h-[700px]">
      <div className="grid  grid-cols-12 lg:gap-20 ">
        <div className="md:col-span-6 col-span-full lg:col-span-5 xl:col-span-4 relative">
          ...
          <div className="Thumbsslide_container lg:opacity-100 opacity-0 xl:-right-10 lg:-right-9 2xl:-right-3">
        ...
        <div className="Slider_Conten mt-10 md:mt-0 col-span-full px-5 lg:px-0 md:col-span-6 ">
          <div className="lg:space-y-40 space-y-10 flex flex-col justify-between h-full">
            ...
            return (
             <div key={ind} className={`${CurrentInd === ind ? "md:flex" :"hidden"}  md:flex-col  md:h-2/3 justify-between`}>
              <div className="feedback ">
                <p className="text-2xl">
                  ❝ {ele.feedback} ❞
                </p>
              </div>
               <div className="flex mt-10 md:mt-0 justify-between">
                <div className="author space-y-1">
                  <h1 className="md:text-2xl uppercase font-bold tracking-wider">
                   {ele.name}
                  </h1>
                  <h1 className="md:text-lg  text-gray-400 tracking-wider">
