  ...
  return (
    <div className='container mt-20 mx-auto'>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-20">
       <div className="cards  grid  col-span-2 lg:grid-cols-1 grid-cols-1">
       <div className="md:grid-cols-2 grid gap-10">
       ...
       <div className="banner mt-10" style={{background:`url(${dep_bg})`, backgroundSize:"cover" }}>
